...
@section('noidung')
    ...
    <div class="homepage-slider">
        ...
        <div class="single-homepage-slider homepage-bg-2">
            @include('partials.banner_content', compact('title', 'subtitle', 'is_slider'))
            {{-- Hoặc có thể dung cách này :
                @include('partials.banner_content', [
                'title' => $title,
                'subtitle' => $subtitle,
                'is_slider' => $is_slider
                ]) --}}
    ...
    <!-- end logo carousel -->
    <style>
        /* CSS cho phần subtitle bị mất */
        .hero-text-tablecell .subtitle-text {
            display: block;
            /* Đảm bảo nằm trên <h1> */
            font-size: 24px;
            /* Phóng to kích thước */
        ...
        /* Đảm bảo title chính cũng đẹp (tùy chọn) */
